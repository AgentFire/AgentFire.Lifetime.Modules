...
namespace Unit_Tests
{
    ...
    public class ExceptionsTests
    {
        ...
        #endregion
        #region ModuleNotFound

        private sealed class NF1 : ModuleBase { }

        [ModuleDependency(typeof(NF1))]
        private sealed class NF2 : ModuleBase { }

        [TestMethod]
        [ExpectedException(typeof(InvalidOperationException))]
        public async Task ModuleNotFound()
        {
            await _manager.Start(default, typeof(NF2));
        }
